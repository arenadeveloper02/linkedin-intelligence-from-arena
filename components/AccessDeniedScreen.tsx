...
/**
 * Shared Arena access-denied UI. Rendered by the /access-denied route and by the
 * app-level gate in app/layout.tsx whenever no emailId is present for the request.
